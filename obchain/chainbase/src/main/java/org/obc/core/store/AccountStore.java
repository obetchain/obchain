...
import org.obc.core.db.accountstate.AccountStateCallBackUtils;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.stereotype.Component;
import org.obc.protos.contract.BalanceContract;
import org.obc.protos.contract.BalanceContract.TransactionBalanceTrace;
import org.obc.protos.contract.BalanceContract.TransactionBalanceTrace.Operation;

@Slf4j(topic = "DB")
@Component
public class AccountStore extends obcStoreWithRevoking<AccountCapsule> {
