...
import org.obc.core.capsule.MarketPriceCapsule;
...
public class MarketUtils {
  ...
  /**
   * ex.
   * for sellToken is A, buyToken is obc.
   * price_A_maker * sellQuantity_maker = Price_obc * buyQuantity_maker
   * ==> price_A_maker = Price_obc * buyQuantity_maker/sellQuantity_maker
   *
  ...
  public static boolean priceMatch(MarketPrice takerPrice, MarketPrice makerPrice) {
    ...
    // price_A_taker * buyQuantity_taker = Price_obc * sellQuantity_taker
    // ==> price_A_taker = Price_obc * sellQuantity_taker/buyQuantity_taker

    // price_A_taker must be greater or equal to price_A_maker
    // price_A_taker / price_A_maker >= 1
    // ==> Price_obc * sellQuantity_taker/buyQuantity_taker >= Price_obc * buyQuantity_maker/sellQuantity_maker
