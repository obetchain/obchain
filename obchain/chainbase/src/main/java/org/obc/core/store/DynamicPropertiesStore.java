...
import org.obc.protos.contract.Common;

@Slf4j(topic = "DB")
@Component
public class DynamicPropertiesStore extends obcStoreWithRevoking<BytesCapsule> {
  ...
  private DynamicPropertiesStore(@Value("properties") String dbName) {
    ...
    try {
      ...
      this.saveCreateAccountFee(100_000L); // 0.1obc
    }
  ...
  public void saveTotalStoragePool(long obc) {
    this.put(TOTAL_STORAGE_POOL,
        new BytesCapsule(ByteArray.fromLong(obc)));
  }
  ...
  public void saveTotalStorageTax(long obc) {
