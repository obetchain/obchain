# Contributing to obchain

obchain is an open source project.
...
First of all, obchain follows GitFlow, the branches description in the obchain project are listed as follow:
...
If you'd like to contribute to obchain, you should follow the steps below:
- **Fork** a repository from **obcprotocol/obchain** allows you to freely experiment with changes without affecting the original project
...
- **Send** a Pull Request（PR）for the maintainers to review and merge into the main code base.
  *notice*：When you create a new PR，please choose the **obcprotocol/obchain** as the base repository and choose **your fork/obchain** as the head repository.
...
we will close the PR and merge into the protocol/obchain's develop branch.
...
issue](https://github.com/obcprotocol/obchain/issues) before anyone
...
Bonus point applies in obc incentives programme. Developers can earn points by contributing to obc.

You can find your points ranking at  [obcscan]

The Top 5 scored developers (for every month, quarter and year) can win a cash reward.

For more details, please visit [Incentives Policy]