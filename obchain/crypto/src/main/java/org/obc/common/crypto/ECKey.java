...
import org.obc.common.crypto.jce.ECKeyPairGenerator;
...
public class ECKey implements Serializable, SignInterface {
  ...
  public ECKey(SecureRandom secureRandom) {
    this(obcCastleProvider.getInstance(), secureRandom);
  }
  ...
  public ECKey(byte[] key, boolean isPrivateKey) {
    ...
    this.provider = obcCastleProvider.getInstance();
  }
