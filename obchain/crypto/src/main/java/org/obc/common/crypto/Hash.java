...
package org.obc.common.crypto;

import static java.util.Arrays.copyOfRange;
import static org.obc.common.utils.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.obc.common.utils.ByteUtil.isNullOrZeroArray;
import static org.obc.common.utils.ByteUtil.isSingleZero;
...
public class Hash {
  ...
  static {
    Security.addProvider(obcCastleProvider.getInstance());
    CRYPTO_PROVIDER = Security.getProvider("SC");
    HASH_256_ALGORITHM_NAME = "obc-KECCAK-256";
    HASH_512_ALGORITHM_NAME = "obc-KECCAK-512";
