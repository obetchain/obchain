package org.obc.common.crypto.sm2;

import static org.obc.common.crypto.Hash.computeAddress;
import static org.obc.common.utils.BIUtil.isLessThan;
import static org.obc.common.utils.ByteUtil.bigIntegerToBytes;
...
import org.obc.common.crypto.jce.ECKeyFactory;
import org.obc.common.crypto.jce.obcCastleProvider;
...
public class SM2 implements Serializable, SignInterface {
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory
            .getInstance(obcCastleProvider.getInstance())
