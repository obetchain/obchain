...
public class Constant {
  ...
  public static final long SUN_PER_ENERGY = 100; // 1 us = 100 SUN = 100 * 10^-6 obc
  ...
  public static final byte[] Zobc_EXPANDSEED_PERSONALIZATION = {'Z', 't', 'r', 'o', 'n', '_', 'E',
      'x',
      'p', 'a', 'n', 'd', 'S', 'e', 'e', 'd'};
  ...
  public static final String NODE_NET_MAX_obc_PER_SECOND = "node.netMaxobcPerSecond";
  ...
  public static final String obc_REFERENCE_BLOCK = "obc.reference.block";

  public static final String obc_EXPIRATION_TIME_IN_MILLIS_SECONDS = "obc.expiration.timeInMilliseconds";
