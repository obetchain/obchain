...
public class Parameter {
  ...
  public static class ChainSymbol {
    ...
    public static final byte[] obc_SYMBOL_BYTES = "_".getBytes(); // obc symbol
  }
  ...
  public class ChainConstant {
    ...
    public static final long obc_PRECISION = 1000_000L;
  }
