package org.obc.common.parameter;
...
import org.obc.core.config.args.Overlay;
...
public class CommonParameter {
  ...
  @Parameter(names = {"--contract-parse-enable"},
      description = "enable contract parses in java-obc or not.(true or false)")
  ...
  //If you are running a solidity node for java obc, this flag is set to true
  @Getter
  @Setter
  ...
  @Getter
  @Setter
  public long netMaxobcPerSecond;
  @Getter
  @Setter
  ...
  @Getter
  @Setter
  public String obcReferenceBlock;
  @Getter
  @Setter
  ...
  @Getter
  @Setter
  public long obcExpirationTimeInMilliseconds; // (ms)
