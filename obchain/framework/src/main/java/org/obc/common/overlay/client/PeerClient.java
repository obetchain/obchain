...
import org.obc.common.overlay.server.obcChannelInitializer;
...
public class PeerClient {
  ...
  public PeerClient() {
    workerGroup = new NioEventLoopGroup(0, new ThreadFactory() {
      ...
      public Thread newThread(Runnable r) {
        return new Thread(r, "obcJClientWorker-" + cnt.getAndIncrement());
      }
    });
  }
  ...
  private ChannelFuture connectAsync(String host, int port, String remoteId,
    ...
    obcChannelInitializer obcChannelInitializer = ctx
        .getBean(obcChannelInitializer.class, remoteId);
    obcChannelInitializer.setPeerDiscoveryMode(discoveryMode);
    ...
    b.handler(obcChannelInitializer);
