package org.obc.common.overlay.server;
...
import org.obc.common.overlay.message.HelloMessage;
import org.obc.common.overlay.message.MessageCodec;
import org.obc.common.overlay.message.StaticMessages;
import org.obc.core.db.ByteArrayWrapper;
import org.obc.core.exception.P2pException;
import org.obc.core.net.PbftHandler;
import org.obc.core.net.obcNetHandler;
...
public class Channel {
  ...
  @Autowired
  private obcNetHandler obcNetHandler;
  @Autowired
  ...
  private obcState obcState = obcState.INIT;
  ...
  public void init(ChannelPipeline pipeline, String remoteId, boolean discoveryMode,
    ...
    pipeline.addLast("lengthDecode", new obcProtobufVarint32FrameDecoder(this));
    ...
    obcNetHandler.setChannel(this);
    pbftHandler.setChannel(this);

    p2pHandler.setMsgQueue(msgQueue);
    obcNetHandler.setMsgQueue(msgQueue);
  ...
  public void publicHandshakeFinished(ChannelHandlerContext ctx, HelloMessage msg) {
    ...
    ctx.pipeline().addLast("data", obcNetHandler);
    ctx.pipeline().addLast("pbft", pbftHandler);
    setStartTime(msg.getTimestamp());
    setobcState(obcState.HANDSHAKE_FINISHED);
  ...
  public void setobcState(obcState obcState) {
    ...
    logger.info("Peer {} status change to {}.", inetSocketAddress, obcState);
  }
