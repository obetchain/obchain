package org.obc.core.config.args;

import static java.lang.Math.max;
import static java.lang.System.exit;
import static org.obc.core.Constant.ADD_PRE_FIX_BYTE_MAINNET;
import static org.obc.core.config.Parameter.ChainConstant.BLOCK_PRODUCE_TIMEOUT_PERCENT;
import static org.obc.core.config.Parameter.ChainConstant.MAX_ACTIVE_WITNESS_NUM;
...
import org.obc.common.args.Account;
import org.obc.common.args.GenesisBlock;
import org.obc.common.args.Witness;
import org.obc.common.config.DbBackupConfig;
...
import org.obc.common.parameter.RateLimiterInitialization;
import org.obc.common.setting.RocksDbSettings;
import org.obc.common.utils.ByteArray;
import org.obc.common.utils.Commons;
import org.obc.common.utils.FileUtil;
import org.obc.common.utils.LocalWitnesses;
import org.obc.common.utils.PropUtil;
import org.obc.core.Constant;
import org.obc.core.Wallet;
import org.obc.core.config.Configuration;
import org.obc.core.config.Parameter.NetConstants;
import org.obc.core.config.Parameter.NodeConstant;
import org.obc.core.config.args.SeedNode;
import org.obc.core.config.args.Storage;
import org.obc.core.exception.CipherException;
import org.obc.core.store.AccountStore;
import org.obc.keystore.Credentials;
import org.obc.keystore.WalletUtils;
...
public class Args extends CommonParameter {
  ...
  public static void clearParam() {
    ...
    PARAMETER.obcExpirationTimeInMilliseconds = 0;
  ...
  public static void setParam(final String[] args, final String confFileName) {
    ...
    PARAMETER.netMaxobcPerSecond = config.hasPath(Constant.NODE_NET_MAX_obc_PER_SECOND)
        ? config.getInt(Constant.NODE_NET_MAX_obc_PER_SECOND)
        : NetConstants.NET_MAX_obc_PER_SECOND;
    ...
    PARAMETER.needToUpdateAsset =
        config.hasPath(Constant.STORAGE_NEEDTO_UPDATE_ASSET) ? config
            ...
            : true;
    PARAMETER.obcReferenceBlock = config.hasPath(Constant.obc_REFERENCE_BLOCK)
        ? config.getString(Constant.obc_REFERENCE_BLOCK) : "head";

    PARAMETER.obcExpirationTimeInMilliseconds =
        config.hasPath(Constant.obc_EXPIRATION_TIME_IN_MILLIS_SECONDS)
            && config.getLong(Constant.obc_EXPIRATION_TIME_IN_MILLIS_SECONDS) > 0
            ? config.getLong(Constant.obc_EXPIRATION_TIME_IN_MILLIS_SECONDS)
