package org.obc.core.zen.note;

import static org.obc.common.zksnark.JLibsodium.CRYPTO_AEAD_CHACHA20POLY1305_IETF_NPUBBYTES;
import static org.obc.core.utils.ZenChainParams.ZC_ENCCIPHERTEXT_SIZE;
import static org.obc.core.utils.ZenChainParams.ZC_ENCPLAINTEXT_SIZE;
import static org.obc.core.utils.ZenChainParams.ZC_OUTCIPHERTEXT_SIZE;
import static org.obc.core.utils.ZenChainParams.ZC_OUTPLAINTEXT_SIZE;
import static org.obc.core.zen.note.NoteEncryption.Encryption.NOTEENCRYPTION_CIPHER_KEYSIZE;
...
import org.obc.common.zksnark.JLibsodiumParam.Chacha20Poly1305IetfEncryptParams;
...
import org.obc.core.zen.note.NoteEncryption.Encryption.EncCiphertext;
import org.obc.core.zen.note.NoteEncryption.Encryption.EncPlaintext;
import org.obc.core.zen.note.NoteEncryption.Encryption.OutCiphertext;
import org.obc.core.zen.note.NoteEncryption.Encryption.OutPlaintext;
...
public class NoteEncryption {
  ...
  public static class Encryption {
    ...
    public static void prfOck(byte[] ock, byte[] ovk, byte[] cv, byte[] cm, byte[] epk)
      ...
      byte[] temp = "Zobc_Derive_ock".getBytes();
    ...
    public static void kdfSapling(byte[] kEnc, byte[] sharedsecret, byte[] epk)
      ...
      byte[] personalization = new byte[JLibsodium.CRYPTO_GENERICHASH_BLAKE2B_PERSONALBYTES];
      byte[] temp = "Zobc_SaplingKDF".getBytes();
      System.arraycopy(temp, 0, personalization, 0, temp.length);
      if (JLibsodium.cryptoGenerichashBlack2bSaltPersonal(new Black2bSaltPersonalParams(
