...
import static org.obc.common.utils.Commons.getAssetIssueStoreFinal;
import static org.obc.common.utils.Commons.getExchangeStoreFinal;
import static org.obc.common.utils.WalletUtil.isConstant;
import static org.obc.core.config.Parameter.ChainConstant.BLOCK_PRODUCED_INTERVAL;
import static org.obc.core.config.Parameter.ChainConstant.FROZEN_PERIOD;
import static org.obc.core.config.Parameter.ChainConstant.WITNESS_STANDBY_LENGTH;
import static org.obc.core.config.Parameter.DatabaseConstants.EXCHANGE_COUNT_LIMIT_MAX;
import static org.obc.core.config.Parameter.DatabaseConstants.MARKET_COUNT_LIMIT_MAX;
import static org.obc.core.config.Parameter.DatabaseConstants.PROPOSAL_COUNT_LIMIT_MAX;
...
import org.obc.common.overlay.discover.node.NodeHandler;
...
import org.obc.common.zksnark.IncrementalMerkleTreeContainer;
import org.obc.common.zksnark.IncrementalMerkleVoucherContainer;
import org.obc.common.zksnark.JLibrustzcash;
import org.obc.common.zksnark.LibrustzcashParam.ComputeNfParams;
import org.obc.common.zksnark.LibrustzcashParam.CrhIvkParams;
import org.obc.common.zksnark.LibrustzcashParam.IvkToPkdParams;
import org.obc.common.zksnark.LibrustzcashParam.SpendSigParams;
...
import org.obc.core.actuator.ActuatorFactory;
...
import org.obc.core.capsule.BlockBalanceTraceCapsule;
import org.obc.core.capsule.BlockCapsule;
import org.obc.core.capsule.BytesCapsule;
import org.obc.core.capsule.CodeCapsule;
...
import org.obc.core.capsule.IncrementalMerkleVoucherCapsule;
...
import org.obc.core.capsule.PedersenHashCapsule;
...
import org.obc.core.db.BandwidthProcessor;
import org.obc.core.db.BlockIndexStore;
import org.obc.core.db.EnergyProcessor;
...
import org.obc.core.exception.NonUniqueObjectException;
import org.obc.core.exception.PermissionException;
import org.obc.core.exception.SignatureFormatException;
...
import org.obc.core.store.AccountIdIndexStore;
import org.obc.core.store.AccountStore;
import org.obc.core.store.AccountTraceStore;
import org.obc.core.store.BalanceTraceStore;
import org.obc.core.store.ContractStore;
import org.obc.core.store.DelegationStore;
...
import org.obc.core.zen.ShieldedTRC20ParametersBuilder;
import org.obc.core.zen.ZenTransactionBuilder;
import org.obc.core.zen.ShieldedTRC20ParametersBuilder.ShieldedTRC20ParametersType;
import org.obc.core.zen.address.DiversifierT;
import org.obc.core.zen.address.ExpandedSpendingKey;
import org.obc.core.zen.address.IncomingViewingKey;
import org.obc.core.zen.address.KeyIo;
import org.obc.core.zen.address.PaymentAddress;
import org.obc.core.zen.address.SpendingKey;
import org.obc.core.zen.note.Note;
import org.obc.core.zen.note.NoteEncryption;
import org.obc.core.zen.note.OutgoingPlaintext;
import org.obc.core.zen.note.NoteEncryption.Encryption;
import org.spongycastle.util.encoders.Hex;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;
import org.springframework.util.CollectionUtils;
import org.obc.api.GrpcAPI;
import org.obc.api.GrpcAPI.AccountNetMessage;
import org.obc.api.GrpcAPI.AccountResourceMessage;
import org.obc.api.GrpcAPI.Address;
import org.obc.api.GrpcAPI.AssetIssueList;
import org.obc.api.GrpcAPI.BlockList;
import org.obc.api.GrpcAPI.BytesMessage;
import org.obc.api.GrpcAPI.DecryptNotes;
import org.obc.api.GrpcAPI.DecryptNotes.NoteTx;
import org.obc.api.GrpcAPI.DecryptNotesTRC20;
import org.obc.api.GrpcAPI.DelegatedResourceList;
import org.obc.api.GrpcAPI.DiversifierMessage;
import org.obc.api.GrpcAPI.ExchangeList;
import org.obc.api.GrpcAPI.ExpandedSpendingKeyMessage;
import org.obc.api.GrpcAPI.IncomingViewingKeyMessage;
import org.obc.api.GrpcAPI.NfParameters;
import org.obc.api.GrpcAPI.NfTRC20Parameters;
import org.obc.api.GrpcAPI.Node;
import org.obc.api.GrpcAPI.NodeList;
import org.obc.api.GrpcAPI.NoteParameters;
import org.obc.api.GrpcAPI.NumberMessage;
import org.obc.api.GrpcAPI.PaymentAddressMessage;
import org.obc.api.GrpcAPI.PrivateParameters;
import org.obc.api.GrpcAPI.PrivateParametersWithoutAsk;
import org.obc.api.GrpcAPI.PrivateShieldedTRC20Parameters;
import org.obc.api.GrpcAPI.PrivateShieldedTRC20ParametersWithoutAsk;
import org.obc.api.GrpcAPI.ProposalList;
import org.obc.api.GrpcAPI.ReceiveNote;
import org.obc.api.GrpcAPI.Return;
import org.obc.api.GrpcAPI.Return.response_code;
import org.obc.api.GrpcAPI.ShieldedAddressInfo;
import org.obc.api.GrpcAPI.ShieldedTRC20Parameters;
import org.obc.api.GrpcAPI.ShieldedTRC20TriggerContractParameters;
import org.obc.api.GrpcAPI.SpendAuthSigParameters;
import org.obc.api.GrpcAPI.SpendNote;
import org.obc.api.GrpcAPI.SpendResult;
import org.obc.api.GrpcAPI.TransactionApprovedList;
import org.obc.api.GrpcAPI.TransactionExtention;
import org.obc.api.GrpcAPI.TransactionExtention.Builder;
...
import org.obc.protos.Protocol.DelegatedResourceAccountIndex;
...
import org.obc.protos.Protocol.MarketPrice;
...
import org.obc.protos.contract.BalanceContract;
import org.obc.protos.contract.BalanceContract.BlockBalanceTrace;
import org.obc.protos.contract.BalanceContract.TransferContract;
import org.obc.protos.contract.ShieldContract.IncrementalMerkleTree;
import org.obc.protos.contract.ShieldContract.IncrementalMerkleVoucherInfo;
import org.obc.protos.contract.ShieldContract.OutputPoint;
import org.obc.protos.contract.ShieldContract.OutputPointInfo;
import org.obc.protos.contract.ShieldContract.PedersenHash;
import org.obc.protos.contract.ShieldContract.ReceiveDescription;
import org.obc.protos.contract.ShieldContract.ShieldedTransferContract;
...
public class Wallet {
  ...
  private void setTransaction(TransactionCapsule obc) {
    try {
      BlockId blockId = chainBaseManager.getHeadBlockId();
      if ("solid".equals(Args.getInstance().getobcReferenceBlock())) {
        blockId = chainBaseManager.getSolidBlockId();
      }
      obc.setReference(blockId.getNum(), blockId.getBytes());
      long expiration = chainBaseManager.getHeadBlockTimeStamp() + Args.getInstance()
          .getobcExpirationTimeInMilliseconds();
      obc.setExpiration(expiration);
      obc.setTimestamp();
    } catch (Exception e) {
  ...
  private TransactionCapsule createTransactionCapsuleWithoutValidateWithTimeout(
      ...
      long timeout) {
    TransactionCapsule obc = new TransactionCapsule(message, contractType);
    try {
      BlockId blockId = chainBaseManager.getHeadBlockId();
      if ("solid".equals(Args.getInstance().getobcReferenceBlock())) {
        blockId = chainBaseManager.getSolidBlockId();
  ...
  public TransactionCapsule createTransactionCapsule(com.google.protobuf.Message message,
    ...
    if (contractType != ContractType.CreateSmartContract
      ...
      List<Actuator> actList = ActuatorFactory.createActuator(obc, chainBaseManager);
    ...
    if (contractType == ContractType.CreateSmartContract) {
      ...
      CreateSmartContract contract = ContractCapsule
          .getSmartContractFromTransaction(obc.getInstance());
  ...
  public GrpcAPI.Return broadcastTransaction(Transaction signedTransaction) {
    ...
    TransactionCapsule obc = new TransactionCapsule(signedTransaction);
    obc.setTime(System.currentTimeMillis());
    try {
      Message message = new TransactionMessage(signedTransaction.toByteArray());
      if (minEffectiveConnection != 0) {
        if (obcNetDelegate.getActivePeer().isEmpty()) {
          logger
              .warn("Broadcast transaction {} has failed, no connection.", obc.getTransactionId());
          return builder.setResult(false).setCode(response_code.NO_CONNECTION)
              .setMessage(ByteString.copyFromUtf8("no connection"))
              .build();
        }

        int count = (int) obcNetDelegate.getActivePeer().stream()
        ...
        if (count < minEffectiveConnection) {
          ...
          logger.warn("Broadcast transaction {} has failed, {}.", obc.getTransactionId(), info);
      ...
      if (dbManager.isTooManyPending()) {
        logger
            .warn("Broadcast transaction {} has failed, too many pending.", obc.getTransactionId());
        return builder.setResult(false).setCode(response_code.SERVER_BUSY).build();
      }

      if (dbManager.getTransactionIdCache().getIfPresent(obc.getTransactionId()) != null) {
        logger.warn("Broadcast transaction {} has failed, it already exists.",
            obc.getTransactionId());
        return builder.setResult(false).setCode(response_code.DUP_TRANSACTION_ERROR).build();
      } else {
        dbManager.getTransactionIdCache().put(obc.getTransactionId(), true);
      }
      if (chainBaseManager.getDynamicPropertiesStore().supportVM()) {
        obc.resetResult();
      }
      dbManager.pushTransaction(obc);
      obcNetService.broadcast(message);
      logger.info("Broadcast transaction {} successfully.", obc.getTransactionId());
      return builder.setResult(true).setCode(response_code.SUCCESS).build();
    } catch (ValidateSignatureException e) {
      logger.error(BROADCAST_TRANS_FAILED, obc.getTransactionId(), e.getMessage());
  ...
  public TransactionApprovedList getTransactionApprovedList(Transaction obc) {
    TransactionApprovedList.Builder tswBuilder = TransactionApprovedList.newBuilder();
    TransactionExtention.Builder obcExBuilder = TransactionExtention.newBuilder();
    obcExBuilder.setTransaction(obc);
    obcExBuilder.setTxid(ByteString.copyFrom(Sha256Hash.hash(CommonParameter
        .getInstance().isECKeyCryptoEngine(), obc.getRawData().toByteArray())));
    Return.Builder retBuilder = Return.newBuilder();
    retBuilder.setResult(true).setCode(response_code.SUCCESS);
    obcExBuilder.setResult(retBuilder);
    tswBuilder.setTransaction(obcExBuilder);
    TransactionApprovedList.Result.Builder resultBuilder = TransactionApprovedList.Result
        .newBuilder();
    try {
      Contract contract = obc.getRawData().getContract(0);
      ...
      if (obc.getSignatureCount() > 0) {
        List<ByteString> approveList = new ArrayList<ByteString>();
        byte[] hash = Sha256Hash.hash(CommonParameter
            .getInstance().isECKeyCryptoEngine(), obc.getRawData().toByteArray());
        for (ByteString sig : obc.getSignatureList()) {
          if (sig.size() < 65) {
  ...
  public DiversifierMessage getDiversifier() throws ZksnarkException {
    ...
    byte[] d;
    while (true) {
      d = org.obc.keystore.Wallet.generateRandomBytes(Constant.ZC_DIVERSIFIER_SIZE);
  ...
  public NodeList listNodes() {
    ...
    nodeHandlerMap.entrySet().stream()
        .forEach(v -> {
          org.obc.common.overlay.discover.node.Node node = v.getValue()
              .getNode();
  ...
  public Transaction deployContract(TransactionCapsule obcCap) {

    // do nothing, so can add some useful function later
    // obcCap contract para cacheUnpackValue has value

    return obcCap.getInstance();
  }

  public Transaction triggerContract(TriggerSmartContract
      triggerSmartContract,
      TransactionCapsule obcCap, Builder builder,
    ...
    if (isConstant(abi, selector)) {
      return callConstantContract(obcCap, builder, retBuilder);
    } else {
      return obcCap.getInstance();
    }
  }
  ...
  public Transaction callConstantContract(TransactionCapsule obcCap, Builder
      builder,
      Return.Builder retBuilder)
      throws ContractValidateException, ContractExeException, HeaderNotFound, VMIllegalException {
    ...
    TransactionContext context = new TransactionContext(new BlockCapsule(headBlock), obcCap,
  ...
  private boolean isShieldedTRC20NoteSpent(GrpcAPI.Note note, long pos, byte[] ak,
    ...
    Return.Builder retBuilder = Return.newBuilder();
    TransactionExtention obcExt;

    try {
      TransactionCapsule obcCap = createTransactionCapsule(trigger,
          ContractType.TriggerSmartContract);
      Transaction obc = triggerConstantContract(trigger, obcCap, obcExtBuilder, retBuilder);

      retBuilder.setResult(true).setCode(response_code.SUCCESS);
      obcExtBuilder.setTransaction(obc);
      obcExtBuilder.setTxid(obcCap.getTransactionId().getByteString());
      ...
      obcExt = obcExtBuilder.build();
    }

    String code = obcExt.getResult().getCode().toString();
    if ("SUCCESS".equals(code)) {
      List<ByteString> list = obcExt.getConstantResultList();
