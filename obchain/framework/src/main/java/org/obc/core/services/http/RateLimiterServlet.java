...
import org.obc.core.services.ratelimiter.RateLimiterContainer;
import org.obc.core.services.ratelimiter.RuntimeData;
import org.obc.core.services.ratelimiter.adapter.DefaultBaseQqsAdapter;
import org.obc.core.services.ratelimiter.adapter.GlobalPreemptibleAdapter;
import org.obc.core.services.ratelimiter.adapter.IPQPSRateLimiterAdapter;
import org.obc.core.services.ratelimiter.adapter.IPreemptibleRateLimiter;
import org.obc.core.services.ratelimiter.adapter.IRateLimiter;
import org.obc.core.services.ratelimiter.adapter.QpsRateLimiterAdapter;
...
public abstract class RateLimiterServlet extends HttpServlet {
  ...
  private static final String ADAPTER_PREFIX = "org.obc.core.services.ratelimiter.adapter.";
