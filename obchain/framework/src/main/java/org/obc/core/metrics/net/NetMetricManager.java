package org.obc.core.metrics.net;
...
public class NetMetricManager {
  ...
  private void setNetInfo(NetInfo netInfo) {
    //set connection info
    netInfo.setConnectionCount(obcNetDelegate.getActivePeer().size());
    int validConnectionCount = 0;
    for (PeerConnection peerConnection : obcNetDelegate.getActivePeer()) {
