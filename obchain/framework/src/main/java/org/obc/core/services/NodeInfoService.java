...
import org.obc.common.entity.PeerInfo;
import org.obc.common.entity.NodeInfo.ConfigNodeInfo;
import org.obc.common.entity.NodeInfo.MachineInfo;
import org.obc.common.entity.NodeInfo.MachineInfo.DeadLockThreadInfo;
import org.obc.common.entity.NodeInfo.MachineInfo.MemoryDescInfo;
...
import org.obc.core.services.WitnessProductBlockService.CheatWitnessInfo;
  ...
  private void setConnectInfo(NodeInfo nodeInfo) {
    ...
    for (PeerConnection peerConnection : syncPool.getActivePeers()) {
      ...
      ReasonCode reasonCode = peerConnection.getNodeStatistics()
          .getobcLastLocalDisconnectReason();
      peerInfo.setLocalDisconnectReason(reasonCode == null ? "" : reasonCode.toString());
      reasonCode = peerConnection.getNodeStatistics().getobcLastRemoteDisconnectReason();
