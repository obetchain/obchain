...
import org.obc.core.metrics.MetricsApiService;
...
import org.obc.api.GrpcAPI.EasyTransferMessage;
...
import org.obc.api.GrpcAPI.IncomingViewingKeyDiversifierMessage;
...
import org.obc.api.GrpcAPI.TransactionList;
import org.obc.api.GrpcAPI.TransactionListExtention;
import org.obc.api.GrpcAPI.TransactionSignWeight;
import org.obc.api.GrpcAPI.ViewingKeyMessage;
import org.obc.api.GrpcAPI.WitnessList;
import org.obc.api.MonitorGrpc;
import org.obc.api.WalletExtensionGrpc;
import org.obc.api.WalletGrpc.WalletImplBase;
...
import org.obc.protos.Protocol.NodeInfo;
...
import org.obc.protos.Protocol.TransactionSign;
import org.obc.protos.contract.AccountContract.AccountCreateContract;
import org.obc.protos.contract.AccountContract.AccountPermissionUpdateContract;
import org.obc.protos.contract.AccountContract.AccountUpdateContract;
...
import org.obc.protos.contract.AssetIssueContractOuterClass.UnfreezeAssetContract;
import org.obc.protos.contract.AssetIssueContractOuterClass.UpdateAssetContract;
import org.obc.protos.contract.BalanceContract;
import org.obc.protos.contract.BalanceContract.AccountBalanceRequest;
import org.obc.protos.contract.BalanceContract.AccountBalanceResponse;
import org.obc.protos.contract.BalanceContract.BlockBalanceTrace;
import org.obc.protos.contract.BalanceContract.FreezeBalanceContract;
import org.obc.protos.contract.BalanceContract.TransferContract;
import org.obc.protos.contract.BalanceContract.UnfreezeBalanceContract;
import org.obc.protos.contract.BalanceContract.WithdrawBalanceContract;
import org.obc.protos.contract.ExchangeContract.ExchangeCreateContract;
import org.obc.protos.contract.ExchangeContract.ExchangeInjectContract;
import org.obc.protos.contract.ExchangeContract.ExchangeTransactionContract;
...
import org.obc.protos.contract.ProposalContract.ProposalApproveContract;
...
import org.obc.protos.contract.SmartContractOuterClass.UpdateEnergyLimitContract;
import org.obc.protos.contract.SmartContractOuterClass.UpdateSettingContract;
...
import org.obc.protos.contract.WitnessContract.WitnessUpdateContract;
...
public class RpcApiService implements Service {
  ...
  private void callContract(TriggerSmartContract request,
    ...
    try {
      TransactionCapsule obcCap = createTransactionCapsule(request,
          ContractType.TriggerSmartContract);
      Transaction obc;
      if (isConstant) {
        obc = wallet.triggerConstantContract(request, obcCap, obcExtBuilder, retBuilder);
      } else {
        obc = wallet.triggerContract(request, obcCap, obcExtBuilder, retBuilder);
      }
      ...
      responseObserver.onNext(obcExtBuilder.build());
  ...
  private TransactionExtention transaction2Extention(Transaction transaction) {
    ...
    TransactionExtention.Builder obcExtBuilder = TransactionExtention.newBuilder();
    Return.Builder retBuilder = Return.newBuilder();
    obcExtBuilder.setTransaction(transaction);
    obcExtBuilder.setTxid(Sha256Hash.of(CommonParameter.getInstance()
        .isECKeyCryptoEngine(), transaction.getRawData().toByteArray()).getByteString());
    retBuilder.setResult(true).setCode(response_code.SUCCESS);
    obcExtBuilder.setResult(retBuilder);
    return obcExtBuilder.build();
  }
  ...
  public class DatabaseApi extends DatabaseImplBase {
    ...
    @Override
    public void getBlockReference(org.obc.api.GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<org.obc.api.GrpcAPI.BlockReference> responseObserver) {
  ...
  public class WalletSolidityApi extends WalletSolidityImplBase {
    ...
    @Override
    public void getMarketOrderListByPair(org.obc.protos.Protocol.MarketOrderPair request,
        StreamObserver<MarketOrderList> responseObserver) {
      try {
  ...
  public class WalletApi extends WalletImplBase {
    ...
    private void createTransactionExtention(Message request, ContractType contractType,
      ...
      Return.Builder retBuilder = Return.newBuilder();
      try {
        TransactionCapsule obc = createTransactionCapsule(request, contractType);
        obcExtBuilder.setTransaction(obc.getInstance());
        obcExtBuilder.setTxid(obc.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
      } catch (ContractValidateException e) {
        retBuilder.setResult(false).setCode(response_code.CONTRACT_VALIDATE_ERROR)
    ...
    public void getTransactionSign2(TransactionSign req,
      ...
      Return.Builder retBuilder = Return.newBuilder();
      try {
        TransactionCapsule obc = TransactionUtil.getTransactionSign(req);
        obcExtBuilder.setTransaction(obc.getInstance());
        obcExtBuilder.setTxid(obc.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
      } catch (Exception e) {
    ...
    public void addSign(TransactionSign req,
      ...
      Return.Builder retBuilder = Return.newBuilder();
      try {
        TransactionCapsule obc = transactionUtil.addSign(req);
        obcExtBuilder.setTransaction(obc.getInstance());
        obcExtBuilder.setTxid(obc.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
      } catch (Exception e) {
    ...
    private void checkVoteWitnessAccount(VoteWitnessContract req) {
      ...
      Preconditions.checkArgument(account.getobcPower() < votesCount,
          "obc power[" + account.getobcPower() + "] <  VotesCount[" + votesCount + "]");
    ...
    public void listNodes(EmptyMessage request, StreamObserver<NodeList> responseObserver) {
      ...
      nodeHandlerMap.entrySet().stream()
          .forEach(v -> {
            org.obc.common.overlay.discover.node.Node node = v.getValue().getNode();
    ...
    public void createShieldedTransaction(PrivateParameters request,
      ...
      try {
        ...
        TransactionCapsule obc = wallet.createShieldedTransaction(request);
        obcExtBuilder.setTransaction(obc.getInstance());
        obcExtBuilder.setTxid(obc.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
    ...
    public void createShieldedTransactionWithoutSpendAuthSig(PrivateParametersWithoutAsk request,
      ...
      try {
        ...
        TransactionCapsule obc = wallet.createShieldedTransactionWithoutSpendAuthSig(request);
        obcExtBuilder.setTransaction(obc.getInstance());
        obcExtBuilder.setTxid(obc.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
      } catch (ContractValidateException | ZksnarkException e) {
    ...
    public void createShieldedContractParameters(
        ...
        StreamObserver<org.obc.api.GrpcAPI.ShieldedTRC20Parameters> responseObserver) {
      try {
        checkSupportShieldedTRC20Transaction();
    ...
    public void scanShieldedTRC20NotesByIvk(
        ...
        StreamObserver<org.obc.api.GrpcAPI.DecryptNotesTRC20> responseObserver) {
      long startNum = request.getStartBlockIndex();
      long endNum = request.getEndBlockIndex();
      try {
        checkSupportShieldedTRC20Transaction();
    ...
    public void getTriggerInputForShieldedTRC20Contract(
        ...
        io.grpc.stub.StreamObserver<org.obc.api.GrpcAPI.BytesMessage> responseObserver) {
      try {
        checkSupportShieldedTRC20Transaction();
