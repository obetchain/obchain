...
import org.obc.common.overlay.client.DatabaseGrpcClient;
...
import org.obc.core.services.http.solidity.SolidityNodeHttpApiService;
...
public class SolidityNode {
  ...
  public static void main(String[] args) {
    ...
    ApplicationContext context = new obcApplicationContext(DefaultConfig.class);
    ...
    nodeManager.close();
    obcNetService obcNetService = context.getBean(obcNetService.class);
    obcNetService.stop();
