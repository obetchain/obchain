contract EnergyOfTransferFailedTest {
    ...
    function testCallobcInsufficientBalance(uint256 i,address payable caller) public {
    ...
    function testSendobcRevert(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.send(i);
        revert();
    }
    ...
    function testTransferobcrevert(uint256 i,address payable nonexistentTarget) payable public{
        nonexistentTarget.transfer(i);
        revert();
    }
