...
public class DepositTest {
  ...
  public void loopCallTest()
    ...
    Runtime runtime = TvmTestUtils
        .processTransactionAndReturnRuntime(aobc, DepositImpl.createRoot(manager),
            null);
    ...
    byte[] aAddress = WalletUtil.generateContractAddress(aobc);
    byte[] bAddress = WalletUtil.generateContractAddress(bobc);
  ...
  public void loopCallTestOldVersion()
    ...
    Runtime runtime = TvmTestUtils.processTransactionAndReturnRuntime(aobc, rootDeposit,
        null);
    Assert.assertNull(runtime.getRuntimeError());
    ...
    Transaction bobc = TvmTestUtils.generateDeploySmartContractAndGetTransaction(
        ...
        null);
    rootDeposit = DepositImpl.createRoot(manager);
    runtime = TvmTestUtils.processTransactionAndReturnRuntime(bobc, rootDeposit, null);
    Assert.assertNull(runtime.getRuntimeError());
