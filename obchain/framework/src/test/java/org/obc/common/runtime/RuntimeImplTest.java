...
import static org.obc.common.runtime.TvmTestUtils.generateDeploySmartContractAndGetTransaction;
import static org.obc.common.runtime.TvmTestUtils.generateTriggerSmartContractAndGetTransaction;
...
public class RuntimeImplTest {
  ...
  public void init() {
    ...
    dbManager.getDynamicPropertiesStore().saveTotalEnergyWeight(5_000_000_000L); // unit is obc
  ...
  public void getCreatorEnergyLimit2Test() throws ContractValidateException, ContractExeException {
    ...
    Transaction obc = generateDeploySmartContractAndGetTransaction(contractName, creatorAddress,
        ABI,
        code, value, feeLimit, consumeUserResourcePercent, libraryAddressPair);

    RuntimeImpl runtimeImpl = new RuntimeImpl();
    runtimeImpl.execute(
        new TransactionContext(null, new TransactionCapsule(obc),
