...
public class BandWidthRuntimeOutOfTimeWithCheckTest {
  ...
  private String obc2ContractAddress = "TPMBUANrTwwQAPwShn7ZZjTJz1f3F8jknj";
  ...
  public void testSuccess() {
    try {
      ...
      TransactionCapsule obcCap = new TransactionCapsule(transaction);
      obcCap.setResultCode(contractResult.OUT_OF_ENERGY);
      TransactionTrace trace = new TransactionTrace(obcCap, StoreFactory.getInstance(),
          new RuntimeImpl());
      dbManager.consumeBandwidth(obcCap, trace);
