...
import org.obc.core.actuator.ExchangeCreateActuator;
...
public class ExchangeCreateActuatorTest {
  ...
  /**
   * SameTokenName close,not obc,ont token is ok, but the second one is not exist.
   */
  @Test
  ...
  /**
   * SameTokenName open,not obc,ont token is ok, but the second one is not exist.
   */
  @Test
