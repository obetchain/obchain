...
import static org.obc.core.net.message.MessageTypes.P2P_DISCONNECT;
import static org.obc.core.net.message.MessageTypes.P2P_HELLO;
import static org.obc.protos.Protocol.ReasonCode.DUPLICATE_PEER;
import static org.obc.protos.Protocol.ReasonCode.FORKED;
import static org.obc.protos.Protocol.ReasonCode.INCOMPATIBLE_CHAIN;
import static org.obc.protos.Protocol.ReasonCode.INCOMPATIBLE_VERSION;
...
import org.obc.common.overlay.message.P2pMessage;
import org.obc.common.overlay.message.P2pMessageFactory;
import org.obc.common.overlay.server.ChannelManager;
import org.obc.common.overlay.server.SyncPool;
import org.obc.common.utils.ReflectUtils;
...
public class TcpTest {
  ...
  public TcpTest(obcApplicationContext context) {
    channelManager = context.getBean(ChannelManager.class);
    manager = context.getBean(Manager.class);
    chainBaseManager = context.getBean(ChainBaseManager.class);
    pool = context.getBean(SyncPool.class);
    obcNetDelegate = context.getBean(obcNetDelegate.class);
  }
  ...
  private void validResultCloseConnect(Channel channel) throws InterruptedException {
    ...
    Collection<PeerConnection> peerConnections = ReflectUtils
        .invokeMethod(obcNetDelegate, "getActivePeer");
