...
import static org.obc.core.capsule.TransactionCapsule.getShieldTransactionHashIgnoreTypeException;
...
import org.obc.common.zksnark.MerklePath;
import org.obc.common.zksnark.ZksnarkClient;
import org.obc.common.zksnark.IncrementalMerkleTreeContainer.EmptyMerkleRoots;
...
import org.obc.common.zksnark.LibrustzcashParam.ComputeCmParams;
import org.obc.common.zksnark.LibrustzcashParam.FinalCheckParams;
...
public class SendCoinShieldTest {
  ...
  public void createCapsule() {
    ...
    AssetIssueContract assetIssueContract = AssetIssueContract.newBuilder()
        ...
        .setId(Long.toString(tokenId)).setTotalSupply(OWNER_BALANCE).setobcNum(obc_NUM).setNum(NUM)
