...
import static org.obc.common.utils.Commons.adjustAssetBalanceV2;
import static org.obc.common.utils.Commons.adjustBalance;
import static org.obc.common.utils.Commons.adjustTotalShieldedPoolValue;
...
public class ManagerTest extends BlockGenerate {
  ...
  public void setBlockReference()
    ...
    if (chainManager.getDynamicPropertiesStore().getLatestBlockHeaderNumber() == 0) {
      ...
      chainManager.setBlockReference(obc);
      Assert.assertEquals(1,
          ByteArray.toInt(obc.getInstance().getRawData().getRefBlockBytes().toByteArray()));
    }
  ...
  public void pushBlockInvalidMerkelRoot() {
    Transaction obc = Transaction.newBuilder().build();
    TransactionCapsule moreTrans = new TransactionCapsule(obc);
  ...
  public void pushBlockTooMuchShieldedTransactions() {
    ShieldContract.ShieldedTransferContract obc1 = ShieldContract.ShieldedTransferContract
        .newBuilder()
        .setFromAmount(10)
        .setToAmount(10)
        .build();
    ShieldContract.ShieldedTransferContract obc2 = ShieldContract.ShieldedTransferContract
        .newBuilder()
        .setFromAmount(20)
        .setToAmount(20)
        .build();
    TransactionCapsule trans1 = new TransactionCapsule(obc1, ContractType.ShieldedTransferContract);
    TransactionCapsule trans2 = new TransactionCapsule(obc2, ContractType.ShieldedTransferContract);
  ...
  public void updateWits() {
    ...
    WitnessCapsule witnessCapsulef =
        new WitnessCapsule(
            ByteString.copyFrom(ByteArray.fromHexString("0x0011")), "www.obc.net/first");
    ...
    WitnessCapsule witnessCapsulet =
        new WitnessCapsule(
            ByteString.copyFrom(ByteArray.fromHexString("0x0013")), "www.obc.net/three");
