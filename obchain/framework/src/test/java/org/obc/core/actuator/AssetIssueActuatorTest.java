...
import org.obc.core.actuator.AssetIssueActuator;
...
import org.obc.core.config.Parameter.ForkBlockVersionConsts;
...
import org.obc.protos.contract.AssetIssueContractOuterClass.AssetIssueContract.FrozenSupply;
...
public class AssetIssueActuatorTest {
  ...
  private Any getContract() {
    ...
    return Any.pack(
        AssetIssueContract.newBuilder()
            ...
            .setName(ByteString.copyFromUtf8(NAME)).setTotalSupply(TOTAL_SUPPLY).setobcNum(obc_NUM)
            .setNum(NUM)
  ...
  public void SameTokenNameCloseAssetIssueSuccess() {
    ...
    try {
      ...
      Assert.assertEquals(obc_NUM, assetIssueCapsule.getobcNum());
      ...
      Assert.assertEquals(obc_NUM, assetIssueCapsuleV2.getobcNum());
  ...
  public void zeroTotalSupplyTest() {
    ...
    Any contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.copyFromUtf8(NAME)).setTotalSupply(0).setobcNum(obc_NUM).setNum(NUM)
            .setStartTime(nowTime).setEndTime(nowTime + 24 * 3600 * 1000)
            .setDescription(ByteString.copyFromUtf8(DESCRIPTION))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
  ...
  @Test
  /*
   * obc num must greater than zero.Else can't asset issue and balance do not
   * change.
   */
  public void negativeobcNumTest() {
    long nowTime = new Date().getTime();
    Any contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
    ...
    try {
      ...
      Assert.assertTrue(e instanceof ContractValidateException);
      Assert.assertTrue("obcNum must greater than 0!".equals(e.getMessage()));
      AccountCapsule owner = dbManager.getAccountStore()
          .get(ByteArray.fromHexString(OWNER_ADDRESS));
      AssetIssueCapsule assetIssueCapsule = dbManager.getAssetIssueStore()
          .get(ByteArray.fromString(NAME));
   ...
   * change.
   */
  public void zeroobcNumTest() {
    long nowTime = new Date().getTime();
    Any contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.copyFromUtf8(NAME)).setTotalSupply(TOTAL_SUPPLY).setobcNum(0)
            .setNum(NUM)
            .setStartTime(nowTime).setEndTime(nowTime + 24 * 3600 * 1000)
            .setDescription(ByteString.copyFromUtf8(DESCRIPTION))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
  ...
  public void assetNameTest() {
    ...
    Any contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.EMPTY).setTotalSupply(TOTAL_SUPPLY).setobcNum(obc_NUM).setNum(NUM)
    ...
    contract = Any.pack(
        AssetIssueContract.newBuilder()
            ...
            .setobcNum(obc_NUM).setNum(NUM).setStartTime(nowTime)
            .setEndTime(nowTime + 24 * 3600 * 1000)
            .setDescription(ByteString.copyFromUtf8(DESCRIPTION))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
    ...
    contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.copyFromUtf8("t e")).setTotalSupply(TOTAL_SUPPLY).setobcNum(obc_NUM)
            .setNum(NUM)
            .setStartTime(nowTime).setEndTime(nowTime + 24 * 3600 * 1000)
            .setDescription(ByteString.copyFromUtf8(DESCRIPTION))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
    ...
    contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.copyFromUtf8("0")).setTotalSupply(TOTAL_SUPPLY).setobcNum(obc_NUM)
            .setNum(NUM)
            .setStartTime(nowTime).setEndTime(nowTime + 24 * 3600 * 1000)
            .setDescription(ByteString.copyFromUtf8(DESCRIPTION))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
  ...
  @Test
  public void assetIssueobcNameTest() {
    dbManager.getDynamicPropertiesStore().saveAllowSameTokenName(1);
    Any contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.copyFromUtf8("obc")).setTotalSupply(TOTAL_SUPPLY).setobcNum(obc_NUM)
            .setNum(NUM)
            .setStartTime(startTime).setEndTime(endTime)
            .setDescription(ByteString.copyFromUtf8("description"))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
    ...
    try {
      ...
      Assert.assertTrue(e instanceof ContractValidateException);
      Assert.assertEquals("assetName can't be obc", e.getMessage());
    } catch (ContractExeException e) {
      Assert.assertFalse(e instanceof ContractExeException);
    } finally {
      dbManager.getAssetIssueStore().delete(ByteArray.fromString(NAME));
  ...
  public void IssueSameTokenNameAssert() {
    ...
    AssetIssueContract assetIssueContract = AssetIssueContract.newBuilder()
        ...
        .setTotalSupply(TOTAL_SUPPLY)
        .setobcNum(obc_NUM).setNum(NUM).setStartTime(1).setEndTime(100).setVoteScore(2)
