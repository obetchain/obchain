...
import static stest.obc.wallet.common.client.utils.PublicMethed.decode58Check;
...
import org.obc.protos.Protocol.BlockHeader.raw;
...
public class WalletTest {
  ...
  private static void addTransactionInfoToStore(Transaction transaction) {
    ...
    byte[] obcId = transaction.getRawData().toByteArray();
    transactionInfo.setId(obcId);
    chainBaseManager.getTransactionHistoryStore().put(obcId, transactionInfo);
  }
