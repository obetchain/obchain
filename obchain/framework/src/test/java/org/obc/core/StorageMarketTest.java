...
import org.obc.protos.contract.StorageContract.BuyStorageContract;
...
public class StorageMarketTest {
  ...
  public void testBuyStorage() {
    ...
    long quant = 2_000_000_000_000L; // 2 million obc
  ...
  public void testBuyStorage2() {
    ...
    long quant = 1_000_000_000_000L; // 1 million obc
  ...
  public void testBuyStorageBytes() {
    ...
    long bytes = 2694881440L; // 2 million obc
  ...
  public void testSellStorage2() {
    ...
    long bytes1 = 2694881440L - 1360781717L; // 1 million obc
    long bytes2 = 1360781717L; // 1 million obc
