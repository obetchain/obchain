...
import org.obc.core.actuator.ExchangeTransactionActuator;
...
public class ExchangeTransactionActuatorTest {
  ...
  private void InitExchangeBeforeSameTokenNameActive() {
    ...
    ExchangeCapsule exchangeCapsule =
        new ExchangeCapsule(
            ...
            obc_SYMBOL_BYTES,
            "abc".getBytes());
    exchangeCapsule.setBalance(1_000_000_000_000L, 10_000_000L); // 1M obc == 10M abc
    ...
    ExchangeCapsule exchangeCapsule3 =
        new ExchangeCapsule(
            ...
            obc_SYMBOL_BYTES,
            "1".getBytes());
    exchangeCapsule3.setBalance(1_000_000_000_000L, 10_000_000L); // 1M obc == 10M abc
  ...
  public void SameTokenNameCloseSuccessExchangeTransaction() {
    ...
    long exchangeId = 1;
    String tokenId = "_";
    long quant = 100_000_000L; // use 100 obc to buy abc
