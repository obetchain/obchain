...
import static stest.obc.wallet.common.client.Parameter.CommonConstant.ADD_PRE_FIX_BYTE_MAINNET;
...
public class DelegationServiceTest {
  ...
  public DelegationServiceTest(obcApplicationContext context) {
