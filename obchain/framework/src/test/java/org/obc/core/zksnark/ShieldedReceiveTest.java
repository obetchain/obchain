...
import org.obc.common.zksnark.LibrustzcashParam.BindingSigParams;
import org.obc.common.zksnark.LibrustzcashParam.CheckOutputParams;
import org.obc.common.zksnark.LibrustzcashParam.CheckSpendParams;
import org.obc.common.zksnark.LibrustzcashParam.IvkToPkdParams;
import org.obc.common.zksnark.LibrustzcashParam.OutputProofParams;
...
import org.obc.core.capsule.ReceiveDescriptionCapsule;
import org.obc.core.capsule.SpendDescriptionCapsule;
...
import org.obc.core.services.http.FullNodeHttpApiService;
import org.obc.core.utils.TransactionUtil;
import org.obc.core.zen.ZenTransactionBuilder;
import org.obc.core.zen.ZenTransactionBuilder.ReceiveDescriptionInfo;
import org.obc.core.zen.ZenTransactionBuilder.SpendDescriptionInfo;
import org.obc.core.zen.address.DiversifierT;
import org.obc.core.zen.address.ExpandedSpendingKey;
import org.obc.core.zen.address.FullViewingKey;
...
import org.obc.core.zen.note.Note.NotePlaintextEncryptionResult;
...
import org.obc.protos.contract.ShieldContract.SpendDescription;
...
public class ShieldedReceiveTest extends BlockGenerate {
  ...
  private static final String ASSET_NAME = "obc";
  private static final int obc_NUM = 10;
  private static final int NUM = 1;
  private static final long START_TIME = 1;
  private static final long END_TIME = 2;
  private static final int VOTE_SCORE = 2;
  private static final String DESCRIPTION = "obc";
  ...
  private static byte[] randomUint256() {
    return org.obc.keystore.Wallet.generateRandomBytes(32);
  }

  private static byte[] randomUint640() {
    return org.obc.keystore.Wallet.generateRandomBytes(80);
  }

  private static byte[] randomUint1536() {
    return org.obc.keystore.Wallet.generateRandomBytes(192);
  }

  private static byte[] randomUint4640() {
    return org.obc.keystore.Wallet.generateRandomBytes(580);
  }
 ...
 */
  ...
  public void testDiversifierT() throws ZksnarkException {
    //byte[] data = org.obc.keystore.Wallet.generateRandomBytes(Constant.ZC_DIVERSIFIER_SIZE);
  ...
  public void testMemoTooLong() throws ContractValidateException, TooBigTransactionException,
    ...
    byte[] memo = org.obc.keystore.Wallet.generateRandomBytes(1024);
    ...
    for (org.obc.protos.Protocol.Transaction.Contract c : t.getRawData().getContractList()) {
  ...
  public void testMemoNotEnough() throws ContractValidateException, TooBigTransactionException,
    ...
    IncomingViewingKey incomingViewingKey = fullViewingKey.inViewingKey();
    PaymentAddress paymentAddress = incomingViewingKey.address(new DiversifierT()).get();
    byte[] memo = org.obc.keystore.Wallet.generateRandomBytes(128);
    builder.addOutput(expsk.getOvk(), paymentAddress,
        100 * 1000000L - wallet.getShieldedTransactionFee(), memo);
  ...
  public void pushSameSkAndScanAndSpend() throws Exception {
    ...
    byte[] memo = org.obc.keystore.Wallet.generateRandomBytes(512);
    ...
    byte[] obcId = transactionCap.getTransactionId().getBytes();
    boolean ok = dbManager.pushTransaction(transactionCap);
    Assert.assertTrue(ok);
    ...
    for (int i = 0; i < notes1.getNoteTxsCount(); i++) {
      ...
      outPointBuild.setHash(ByteString.copyFrom(obcId));
    ...
    for (int i = 0; i < 1; i++) {
      org.obc.api.GrpcAPI.Note grpcNote = notes1.getNoteTxs(i).getNote();
    ...
    byte[] memo3 = org.obc.keystore.Wallet.generateRandomBytes(512);
  ...
  public void decodePaymentAddressIgnoreCase() {
    String addressLower =
        "zobc1975m0wyg8f30cgf2l5fgndhzqzkzgkgnxge8cwx2wr7m3q7chsuwewh2e6u24yykum0hq8ue99u";
