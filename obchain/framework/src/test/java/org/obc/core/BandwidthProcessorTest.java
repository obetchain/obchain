...
public class BandwidthProcessorTest {
  ...
  private static final int obc_NUM = 2;
  ...
  public void testCreateNewAccount() throws Exception {
    ...
    TransactionCapsule obc = new TransactionCapsule(transferAssetContract);
    ...
    org.obc.protos.Protocol.Transaction.Contract contract =
        org.obc.protos.Protocol.Transaction.Contract
            .newBuilder()
    ...
    long bytes = obc.getSerializedSize();
  ...
  public void testFree() throws Exception {
    ...
    TransactionCapsule obc = new TransactionCapsule(contract);
    ...
    TransactionTrace trace = new TransactionTrace(obc, StoreFactory
        .getInstance(), new RuntimeImpl());
    dbManager.consumeBandwidth(obc, trace);
  ...
  public void sameTokenNameCloseConsumeSuccess() {
    ...
    long byteSize = obc.getInstance().toBuilder().clearRet().build().getSerializedSize()
        + Constant.MAX_RESULT_SIZE_IN_TX;
  ...
  public void sameTokenNameCloseTransferToAccountNotExist() {
    ...
    TransactionCapsule obc = new TransactionCapsule(contract, chainBaseManager.getAccountStore());
    TransactionTrace trace = new TransactionTrace(obc, StoreFactory
        .getInstance(), new RuntimeImpl());
