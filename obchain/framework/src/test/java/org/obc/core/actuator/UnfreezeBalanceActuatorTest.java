...
import org.obc.core.actuator.UnfreezeBalanceActuator;
...
public class UnfreezeBalanceActuatorTest {
  ...
  public void testUnfreezeBalanceForBandwidth() {
    ...
    Assert.assertEquals(accountCapsule.getobcPower(), frozenBalance);
    ...
    try {
      ...
      Assert.assertEquals(owner.getobcPower(), 0L);
  ...
  public void testUnfreezeDelegatedBalanceForBandwidth() {
    ...
    try {
      ...
      Assert.assertEquals(0L, ownerResult.getobcPower());
