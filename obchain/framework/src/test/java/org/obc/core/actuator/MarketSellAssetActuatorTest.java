...
import org.obc.core.actuator.MarketSellAssetActuator;
...
public class MarketSellAssetActuatorTest {
  ...
  private static final String obc = "_";
  ...
  /**
   * no Enough Balance For Selling obc, result is failed, exception is "No enough balance !".
   */
  @Test
  public void noEnoughBalanceForSellingobc() {
  ...
  /**
   * no buy orders before,add first sell order,selling obc and buying token
   */
  @Test
  ...
  /**
   * no buy orders before,add first sell order,selling Token and buying obc
   */
  @Test
