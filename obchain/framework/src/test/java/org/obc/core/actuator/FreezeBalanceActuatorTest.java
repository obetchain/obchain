...
import static org.obc.core.config.Parameter.ChainConstant.TRANSFER_FEE;
...
import org.obc.protos.contract.Common.ResourceCode;
...
public class FreezeBalanceActuatorTest {
  ...
  public void testFreezeBalanceForBandwidth() {
    ...
    try {
      ...
      Assert.assertEquals(frozenBalance, owner.getobcPower());
  ...
  public void testFreezeDelegatedBalanceForBandwidth() {
    ...
    try {
      ...
      Assert.assertEquals(0L, receiver.getobcPower());
  ...
  public void lessThan1obcTest() {
    ...
    try {
      ...
      Assert.assertTrue(e instanceof ContractValidateException);
      Assert.assertEquals("frozenBalance must be more than 1obc", e.getMessage());
    } catch (ContractExeException e) {
      Assert.assertFalse(e instanceof ContractExeException);
    }
  }
