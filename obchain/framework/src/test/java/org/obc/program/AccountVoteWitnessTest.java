...
public class AccountVoteWitnessTest {
  ...
  private List<AccountCapsule> getAccountList() {
    ...
    final AccountCapsule accountobc =
        new AccountCapsule(
            ByteString.copyFrom("00000000001".getBytes()),
            ByteString.copyFromUtf8("obc"),
            AccountType.Normal);
    ...
    final AccountCapsule accountVivider =
        new AccountCapsule(
            ...
            AccountType.Normal);
    // accountobc addVotes
    accountobc.addVotes(accountMarcus.getAddress(), 100);
    accountobc.addVotes(accountOlivier.getAddress(), 100);
    accountobc.addVotes(accountSasaXie.getAddress(), 100);
    accountobc.addVotes(accountVivider.getAddress(), 100);

    // accountMarcus addVotes
    accountMarcus.addVotes(accountobc.getAddress(), 100);
    ...
    accountOlivier.addVotes(accountobc.getAddress(), 100);
    ...
    accountCapsuleList.add(accountobc);
  ...
  private List<WitnessCapsule> getWitnessList() {
    ...
    final WitnessCapsule witnessobc =
    ...
    witnessCapsuleList.add(witnessobc);
