...
import static org.obc.common.utils.WalletUtil.generateContractAddress;
...
public class ProgramInvokeFactoryImpl implements ProgramInvokeFactory {
  ...
  @Override
  public ProgramInvoke createProgramInvoke(InternalTransaction.obcType obcType,
    ...
    if (obcType == obc_CONTRACT_CREATION_TYPE) {
    ...
    } else if (obcType == obc_CONTRACT_CALL_TYPE) {
