...
public class AssetIssueActuator extends AbstractActuator {
  ...
  public boolean validate() throws ContractValidateException {
    ...
    if (dynamicStore.getAllowSameTokenName() != 0) {
      ...
      if (("obc").equals(name)) {
        throw new ContractValidateException("assetName can't be obc");
      }
    }
    ...
    if (assetIssueContract.getobcNum() <= 0) {
      throw new ContractValidateException("obcNum must greater than 0!");
    }
