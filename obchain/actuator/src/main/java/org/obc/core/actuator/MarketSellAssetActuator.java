...
import org.obc.protos.Protocol.MarketOrderDetail;
...
public class MarketSellAssetActuator extends AbstractActuator {
  ...
  private void matchSingleOrder(MarketOrderCapsule takerOrderCapsule,
    ...
    // for makerPrice,sellToken is A,buyToken is obc.
    // for takerPrice,buyToken is A,sellToken is obc.

    // makerSellTokenQuantity_A/makerBuyTokenQuantity_obc =
    //   takerBuyTokenQuantityCurrent_A/takerSellTokenQuantityRemain_obc
    // => takerBuyTokenQuantityCurrent_A = takerSellTokenQuantityRemain_obc *
    //   makerSellTokenQuantity_A/makerBuyTokenQuantity_obc
    ...
    if (takerBuyTokenQuantityRemain == makerOrderCapsule.getSellTokenQuantityRemain()) {
      ...
      // makerSellTokenQuantityRemain_A/makerBuyTokenQuantityCurrent_obc =
      //   makerSellTokenQuantity_A/makerBuyTokenQuantity_obc
      // => makerBuyTokenQuantityCurrent_obc = makerSellTokenQuantityRemain_A *
      //   makerBuyTokenQuantity_obc / makerSellTokenQuantity_A
    ...
    addobcOrToken(takerOrderCapsule, takerBuyTokenQuantityReceive, takerAccountCapsule);
    addobcOrToken(makerOrderCapsule, makerBuyTokenQuantityReceive);
  ...
  // for taker
  private void addobcOrToken(MarketOrderCapsule orderCapsule, long num,
