...
import static org.obc.core.vm.trace.Serializers.serializeFieldsOnly;

import java.util.ArrayList;
import java.util.List;

import org.obc.common.runtime.vm.DataWord;
import org.obc.core.vm.OpCode;
...
public class ProgramTrace {
  ...
  public ProgramTrace(VMConfig config, ProgramInvoke programInvoke) {
    if (programInvoke != null && config.vmTrace()) {
      contractAddress = Hex
          .toHexString(convertToobcAddress(programInvoke.getContractAddress().getLast20Bytes()));
    }
  }
