...
import static org.obc.common.crypto.Hash.sha3;
...
import static org.obc.core.vm.OpCode.*;
...
import org.obc.core.vm.program.Stack;
...
public class VM {
  ...
  private boolean isDeadAccount(Program program, DataWord address) {
    return program.getContractState().getAccount(convertToobcAddress(address.getLast20Bytes()))
        == null;
  }
}
