...
package org.obc.core.vm;

import static org.obc.common.runtime.vm.DataWord.WORD_SIZE;
import static org.obc.common.utils.BIUtil.addSafely;
import static org.obc.common.utils.BIUtil.isLessThan;
import static org.obc.common.utils.BIUtil.isZero;
import static org.obc.common.utils.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.obc.common.utils.ByteUtil.bytesToBigInteger;
import static org.obc.common.utils.ByteUtil.merge;
import static org.obc.common.utils.ByteUtil.numberOfLeadingZeros;
import static org.obc.common.utils.ByteUtil.parseBytes;
import static org.obc.common.utils.ByteUtil.parseWord;
import static org.obc.common.utils.ByteUtil.stripLeadingZeroes;
import static org.obc.core.db.TransactionTrace.convertToobcAddress;
...
import org.obc.common.crypto.SignatureInterface;
import org.obc.common.crypto.zksnark.BN128;
import org.obc.common.crypto.zksnark.BN128Fp;
import org.obc.common.crypto.zksnark.BN128G1;
import org.obc.common.crypto.zksnark.BN128G2;
import org.obc.common.crypto.zksnark.Fp;
import org.obc.common.crypto.zksnark.PairingCheck;
...
import org.obc.common.utils.BIUtil;
...
import org.obc.common.zksnark.LibrustzcashParam;
  ...
  public static class ValidateMultiSign extends PrecompiledContract {
    ...
    public Pair<Boolean, byte[]> execute(byte[] rawData) {
      ...
      byte[] combine = ByteUtil
          .merge(convertToobcAddress(addr), ByteArray.fromInt(permissionId), data);
      ...
      AccountCapsule account = this.getDeposit().getAccount(convertToobcAddress(addr));
      if (account != null) {
        try {
