...
public class TransferActuator extends AbstractActuator {
  ...
  public boolean validate() throws ContractValidateException {
    ...
    if (Arrays.equals(toAddress, ownerAddress)) {
      throw new ContractValidateException("Cannot transfer obc to yourself.");
    }
    ...
    try {
      ...
      //after ForbidTransferToContract proposal, send obc to smartContract by actuator is not allowed.
      if (dynamicStore.getForbidTransferToContract() == 1
          && toAccount != null
          && toAccount.getType() == AccountType.Contract) {

        throw new ContractValidateException("Cannot transfer obc to a smartContract.");
