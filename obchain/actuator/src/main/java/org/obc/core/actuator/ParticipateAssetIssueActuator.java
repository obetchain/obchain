...
public class ParticipateAssetIssueActuator extends AbstractActuator {
  ...
  public boolean execute(Object object) throws ContractExeException {
    ...
    try {
      ...
      exchangeAmount = Math.floorDiv(exchangeAmount, assetIssueCapsule.getobcNum());
...
//    }
    ...
    try {
      ...
      int obcNum = assetIssueCapsule.getobcNum();
      int num = assetIssueCapsule.getNum();
      long exchangeAmount = Math.multiplyExact(amount, num);
      exchangeAmount = Math.floorDiv(exchangeAmount, obcNum);
      if (exchangeAmount <= 0) {
