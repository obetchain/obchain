...
//      }
  ...
  public enum ProposalType {         // current value, value range
    ...
    ACCOUNT_UPGRADE_COST(1), // 9999 obc, [0, 100000000000] obc
    CREATE_ACCOUNT_FEE(2), // 0.1 obc, [0, 100000000000] obc
    TRANSACTION_FEE(3), // 10 Sun/Byte, [0, 100000000000] obc
    ASSET_ISSUE_FEE(4), // 1024 obc, [0, 100000000000] obc
    WITNESS_PAY_PER_BLOCK(5), // 16 obc, [0, 100000000000] obc
    WITNESS_STANDBY_ALLOWANCE(6), // 115200 obc, [0, 100000000000] obc
    CREATE_NEW_ACCOUNT_FEE_IN_SYSTEM_CONTRACT(7), // 0 obc, [0, 100000000000] obc
    ...
    ENERGY_FEE(11), // 10 Sun, [0, 100000000000] obc
    EXCHANGE_CREATE_FEE(12), // 1024 obc, [0, 100000000000] obc
    ...
    UPDATE_ACCOUNT_PERMISSION_FEE(22), // 100 obc, [0, 100000] obc
    MULTI_SIGN_FEE(23), // 1 obc, [0, 100000] obc
